...
rm -f $HOME/{.zshenv,.zprofile,.zshrc,.zlogin,.zlogout} && ln -s $DOTFILES/zsh/{zshenv,zprofile,zshrc,zlogin,zlogout} $HOME/{.zshenv,.zprofile,.zshrc,.zlogin,.zlogout} 
rm -rf $HOME/.vim && ln -s $DOTFILES/vim $HOME/.vim
rm -f $HOME/.gitignore && ln -s $DOTFILES/git/gitignore
rm -f $HOME/.gitconfig && ln -s $DOTFILES/git/gitconfig
